...
method createReservation*(
  ...
  requestId: RequestId,
  slotIndex: UInt256,
  collateralPerByte: UInt256): Future[?!Reservation] {.async.} =
    ...
    return await procCall createReservation(Reservations(self), availabilityId,
      slotSize, requestId, slotIndex, collateralPerByte)
